...
Pour chaque binôme, *un seul d’entre vous* devra faire un /fork/ de ce squelette de projet, puis y ajouter son camarade de binôme, et ainsi partager le projet sous GitLab. Pour cela :
  ...
  - Dans l’onglet =Projects > Your projects=, sélectionnez le projet =CRYPTO-2026/TME= (où =TME= correspond au nom du projet du TME en cours), cliquez sur le bouton =Fork= puis cliquez sur votre nom. Ceci crée le projet personnel privé nommé =username/TME= (où =username= est votre numéro d’étudiant). Vous travaillerez désormais dans ce projet, où vous avez les droits d’écriture.
  - Dans l’onglet =Projects > Your projects=, sélectionnez ce projet privé. Il doit avoir pour nom =username/TME= et porter la mention =Forked from CRYPTO-2026/TME=. Cliquez sur =Project Information= dans le menu de gauche, puis =Members=. *Invitez votre binôme* en lui donnant pour rôle =Maintainer=.
...
** Faire une copie locale de votre projet
   ...
   *Prenez garde* à bien importer votre projet de binôme, =username/TME=, et pas =CRYPTO-2026/TME=. Vous ne pourrez pas travailler dans ce dernier, qui est en lecture seule.
...
** Mettre à jour sa version du TME
   ...
   #+begin_src shell
     ...
     git remote add upstream https://stl.algo-prog.info/crypto-2026/tme3-arithmetique_dlp
   #+end_src
